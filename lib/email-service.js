 ...
 */
export async function sendWaitlistEmail(userEmail, userName = 'User', productName, adminEmail, phone) {
  try {
    const emailUser = process.env.EMAIL_USER?.trim();
    const emailPass = process.env.EMAIL_PASS?.trim().replace(/\s/g, '');
    ...
    let productImgName = "Mango%20Achar.jpg"; // fallback
    const lowerName = productName.toLowerCase();
    if (lowerName.includes('lasoon') || lowerName.includes('garlic')) productImgName = "Lasson%20Achar.jpg";
    else if (lowerName.includes('adrak') || lowerName.includes('ginger')) productImgName = "Adrak%20Achar.jpg";
    else if (lowerName.includes('mirchi') || lowerName.includes('chilli')) productImgName = "Mirchi%20Achar.jpg";
    else if (lowerName.includes('amla')) productImgName = "Amla%20Achar.jpg";
    else if (lowerName.includes('haldi')) productImgName = "Haldi%20Achar.jpg";

    const imgUrl = `https://www.mewari-achar.shop/Images/${productImgName}`;
...
<body style="font-family: sans-serif; background:#f4f4f4; padding:20px;">
  <div style="background:#fff; padding:30px; border-radius:10px; border-top: 5px solid #8B0000; max-width: 600px; margin: auto;">
    ...
    <img src="${imgUrl}" alt="${productName}" style="width: 150px; height: 150px; border-radius: 8px; object-fit: cover; margin-top: 10px; margin-bottom: 10px; border: 1px solid #ddd;" />
    ...
    if (adminEmail) {
      ...
      const adminMailOptions = {
        ...
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f9f9f9;">
          <div style="max-width: 600px; background: #fff; padding: 20px; border-radius: 8px; border-top: 5px solid #D4AF37;">
            <h2 style="color: #8B0000; margin-top: 0;">New Waitlist Request 📋</h2>
            <img src="${imgUrl}" alt="${productName}" style="width: 100px; height: 100px; border-radius: 8px; object-fit: cover; margin-bottom: 15px; border: 1px solid #ddd;" />
            <table style="width: 100%; border-collapse: collapse;">
              <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee;"><strong>Product:</strong></td><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #8B0000; font-weight: bold;">${productName}</td></tr>
              ...
              <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee;"><strong>Email ID:</strong></td><td style="padding: 8px 0; border-bottom: 1px solid #eee;"><a href="mailto:${userEmail}">${userEmail}</a></td></tr>
              <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee;"><strong>Phone:</strong></td><td style="padding: 8px 0; border-bottom: 1px solid #eee;"><a href="tel:${phone}">${phone || 'Not provided'}</a></td></tr>
              ...
              <tr><td style="padding: 8px 0;"><strong>Time:</strong></td><td style="padding: 8px 0;">${timeStr}</td></tr>
            </table>
          </div>
        </div>
        `
